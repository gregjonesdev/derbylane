...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        calibrator = "weka.classifiers.functions.Logistic -R 1.0E-8 -M -1 -num-decimal-places 4"
        print("Prepare to create model:")
        print("Arff file: {}".format(arff_file))
        print("Classifier: {}".format(classifier))
        print("New Optiosn: {}".format(smo_options))
        print("Root Filename: {}".format(root_filename))
        create_model(arff_file, classifier, smo_options, root_filename)
        jvm.stop()
